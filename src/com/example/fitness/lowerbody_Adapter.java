...
public class lowerbody_Adapter extends BaseAdapter {
	
	ArrayList<singleRow> mylist;
	Context _context;
	
	public lowerbody_Adapter(Context c) {
		...
		String title[]=res.getStringArray(R.array.lowerbody_titles);
		String description[]=res.getStringArray(R.array.lowerbody_description);
		int[]image={R.drawable.lower1,R.drawable.lower2,R.drawable.lower3,R.drawable.lower4,R.drawable.lower5,R.drawable.lower6};
